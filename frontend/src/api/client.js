...
// Use relative paths since frontend is served by FastAPI on same origin
// This allows the app to work anywhere without configuration
const API_URL = ''
...
export const queryKnowledge = async (query, synthesize = true, top_k = 5, namespace = null, rerank = false) => {
...
export const createNamespaceApi = async ({ id, name, description, parent_id, metadata }) => {
...
export const updateNamespace = async (id, { name, description, parent_id, metadata }) => {

...
def test_client(mock_pipeline):
    ...
    with patch('ragbrain.api.routes.query.get_pipeline', return_value=mock_pipeline):
        with patch('ragbrain.api.routes.capture.get_pipeline', return_value=mock_pipeline):
            from ragbrain.api.main import app

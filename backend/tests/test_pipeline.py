...
from ragbrain.rag.pipeline import RAGPipeline, get_pipeline
...
class TestRAGPipeline:
    ...
    @pytest.fixture
    def mock_pipeline(self, mock_embedding_provider, mock_llm_provider, mock_vectordb_provider):
    ...
    def test_lazy_load_embedding_provider(self):
        ...
        with patch('ragbrain.rag.pipeline.EmbeddingProviderFactory') as mock_factory:
    ...
    def test_lazy_load_llm_provider(self):
        ...
        with patch('ragbrain.rag.pipeline.LLMProviderFactory') as mock_factory:
            mock_provider = MagicMock()
            mock_factory.create.return_value = mock_provider
    ...
    def test_lazy_load_vectordb_provider(self):
        ...
        with patch('ragbrain.rag.pipeline.VectorDBProviderFactory') as mock_factory:
            mock_provider = MagicMock()
            mock_factory.create.return_value = mock_provider
    ...
    def test_ingest_text_with_namespace(self, mock_pipeline):
        ...
        # Check that namespace was passed to insert
        call_args = mock_pipeline._vectordb_provider.insert.call_args
    ...
    def test_query_with_synthesis(self, mock_pipeline):
        ...
        assert result["question"] == "What is RAGBrain?"
    ...
    def test_query_with_namespace(self, mock_pipeline):
        ...
        assert result["namespace"] == "test-namespace"
        # Check that namespace was passed to search
        call_args = mock_pipeline._vectordb_provider.search.call_args
        assert call_args.kwargs.get("namespace") == "test-namespace"
    ...
    def test_query_empty_results(self, mock_pipeline):
        ...
        mock_pipeline._vectordb_provider.search.return_value = []
...
class TestGetPipeline:
    ...
    def test_get_pipeline_returns_instance(self):
        ...
        import ragbrain.rag.pipeline as pipeline_module
...
class TestPipelineIntegration:
    ...
    def test_full_ingest_and_query_flow(
        ...
        ingest_result = pipeline.ingest_text(
            text="RAGBrain is a personal knowledge base system. It uses AI to help organize information.",
        ...
        assert query_result["question"] == "What is RAGBrain?"

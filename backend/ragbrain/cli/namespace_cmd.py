...
def export_namespaces(output: Path | None, fmt: str, pretty: bool):
    ...
    Examples:
        ragbrain namespace-export namespaces.json
        ragbrain namespace-export --format jsonl namespaces.jsonl
        ragbrain namespace-export --pretty  # print to stdout
    """
...
def import_namespaces(input_file: Path, dry_run: bool, skip_existing: bool, update_existing: bool):
    ...
    Examples:
        ragbrain namespace-import namespaces.json
        ragbrain namespace-import --dry-run namespaces.json
        ragbrain namespace-import --skip-existing namespaces.json
        ragbrain namespace-import --update-existing namespaces.json
    """
